...
# python -m torch.distributed.launch --nproc_per_node=4  tools/train.py --launcher pytorch /mnt/data/tcy/
...
#print(f"No CUDA runtime is found, using CUDA_HOME='{cuda_home}'" RANK)
    ...
    if cfg.checkpoint_config is not None:
        # save mmdet version, config file content and class names in elapsed:
